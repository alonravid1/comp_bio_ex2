...
if __name__ == "__main__":
    ...
    #     # res.write("word_weight,letter_weight,pairs_weight,fitness_count,score,cover:\n")
    ...
    #         avg_fitness = 0
    #         avg_cover = 0
    #         # word_weight, letter_weight ,pairs_weight = param
    #         gen_size = param
    #         # mutation_rate = param

    #         algo_settings = [replication_rate, cross_over_rate,
    #                         mutation_rate, mutation_number, gen_size,
    #                          word_weight, letter_weight, pairs_weight,
    #                         enc_mess, letter_freq, pair_freq, word_dict, swaps, executor, pickle_eval_word]
            
    #         for i in range(repeats):
    #             genetic_algo = LamarckAlgo(*algo_settings)
    ...
    #         plain_text = genetic_algo.decode_message(solution, enc_mess)
    #         print(plain_text)
